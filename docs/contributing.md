...
Contributions are welcome. `go-ruby-rational/rational` is built to a small set of
...
- **Differential testing against MRI.** Correctness is defined by reference Ruby. A corpus
  is run through both `ruby` and this library and the inspected results are compared
...
- **MRI-faithful, not a generic rational.** This module reproduces Ruby's exact
  semantics. A generic mathematical rational belongs in
  [go-composites/rational](https://github.com/go-composites/rational), not here.
...
The library is in
[`github.com/go-ruby-rational/rational`](https://github.com/go-ruby-rational/rational).
This documentation site is in
[`github.com/go-ruby-rational/docs`](https://github.com/go-ruby-rational/docs). Start from
